...
cdef extern from "vm.h":
    ...
    int vm_cont(VMState *state, VMStateDiff *diffs, int *hit_bp)
    void vm_rcont(VMState *state, VMStateDiff *diffs, int *hit_bp)
    void vm_step(VMState *state, int nsteps, VMStateDiff *diffs, int *hit_bp)
    void vm_rstep(VMState *state, int nsteps, VMStateDiff *diffs, int *hit_bp)
