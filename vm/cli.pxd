...
cdef extern from "vm.h":
    ...
    void vm_rcont(VMState *state, VMStateDiff *diffs, bint *hit_bp)
    void vm_step(VMState *state, int nsteps, VMStateDiff *diffs, bint *hit_bp)
    void vm_rstep(VMState *state, int nsteps, VMStateDiff *diffs, bint *hit_bp)
