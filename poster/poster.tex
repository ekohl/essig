...
\begin{columns}[t]
\begin{column}{.02\linewidth}\end{column}
\begin{column}{.475\linewidth}\input{example}\end{column}
\begin{column}{.01\linewidth}\end{column}
\begin{column}{.475\linewidth}\input{outputsim}\end{column}
\begin{column}{.02\linewidth}\end{column}
\end{columns}
...
\begin{columns}[t]
\begin{column}{.02\linewidth}\end{column}
\begin{column}{.97\linewidth}\input{future}\end{column}
\begin{column}{.02\linewidth}\end{column}
\end{columns}
...
\begin{columns}[t]
\begin{column}{.02\linewidth}\end{column}
\begin{column}{.475\linewidth}\input{results}\end{column}
\begin{column}{.01\linewidth}\end{column}
